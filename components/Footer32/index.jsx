...
function Footer32(props) {
  ...
  return (
    <Footer className={`footer-20 ${className || ""}`}>
      <FlexRow className="flex-row-7">
        <APropos className="a-propos-2">
          <PROPOS className="propos-2">À PROPOS</PROPOS>
          <Composant371 />
          <Composant381 />
          <Composant391 />
        </APropos>
        <AccsDirect className="accs-direct-4">
          <ACCSDIRECT className="accs-direct-5">ACCÈS DIRECT</ACCSDIRECT>
        ...
        <Etablissements className="etablissements-2">
          <TABLISSEMENTS className="tablissements-2">ÉTABLISSEMENTS</TABLISSEMENTS>
        ...
        <RseauxSociaux className="rseaux-sociaux-2">
          <TABLISSEMENTS className="connect-2">CONNECT</TABLISSEMENTS>
          <FlexRow1 className="flex-row-8">
      ...
      <OverlapGroup1 className="overlap-group1-7">
        ...
        <Copyright className="copyright-2">© 2021</Copyright>
      </OverlapGroup1>
    </Footer>
  );
}
